    ...
    const loadDictionary = async () => {
      try {
        ...
        const parsedEntries = lines
          ...
          .map(line => {
            const [word, amiyah_arab, indonesia, fushah, fushah_arab, contoh] = line.split(',');
            return { word, amiyah_arab, indonesia, fushah, fushah_arab, contoh };
          });
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-50 p-4">
      <div className="max-w-4xl mx-auto">
        <div className="flex items-center justify-center gap-3 mb-8">
          ...
          <h1 className="text-4xl font-bold text-gray-800">Kamus Arab</h1>
        </div>
          ...
          <div className="space-y-4">
            {filteredEntries.length === 0 ? (
              <div className="text-center py-12 bg-white rounded-lg shadow-lg">
                <p className="text-gray-600 text-lg">Tidak ada kata yang cocok dengan pencarian Anda.</p>
              </div>
            ) : (
                  ...
                  <div className="space-y-4">
                    <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                      <div>
                        ...
                        <p className="text-xl text-gray-600 font-arabic mt-1">{entry.amiyah_arab}</p>
                      </div>
                      <div className="text-right">
                        <p className="text-lg text-indigo-600 font-semibold">{entry.indonesia}</p>
                      </div>
                    </div>
                    ...
                    <div className="border-t border-gray-100 pt-4">
                      ...
                      <div className="flex items-center justify-between">
                        ...
                        <p className="text-lg text-gray-600 font-arabic">{entry.fushah_arab}</p>
                      </div>
                    </div>
                    
                    <div className="border-t border-gray-100 pt-4">
                      <h3 className="text-sm font-semibold text-gray-500 mb-2">Contoh Penggunaan:</h3>
